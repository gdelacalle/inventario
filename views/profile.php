                            ...
                            <div class="card-body pt-3">
                                ...
                                <div class="tab-content pt-2">
                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <p class="small fst-italic">Sistema de Inventario - ESTRUCTURAS VEGA</p>
                                        <br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8"><?php echo $fila['descripcion']; ?></div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                        ...
                                        <form id="form">
                                            ...
                                            <div class="row mb-3">
                                                <label for="Job" class="col-md-4 col-lg-3 col-form-label">Tipo de Usuario</label>
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="descripcion" type="text" class="form-control" id="descripcion" readonly value="<?php echo $fila['descripcion']; ?>">
                                                </div>
                                            </div>
