<div class="modal fade" id="editarprov<?php echo $fila['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h3 class="modal-title" id="exampleModalLabel">Modificar Datos del Proveedor</h3>
            ...
            <div class="modal-body">
                <form id="editProv<?php echo $fila['id']; ?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <label for="password">CUIT </label><br>
                                <input type="text" name="cuit" id="cuit" class="form-control" value="<?php echo $fila['cuit']; ?>" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
