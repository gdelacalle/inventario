...
<table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                $total=0;
                    ...
                    p.id, cast((e.peso*p.metros)as decimal(10,2))as peso,e.seccion,i.producto,p.cantidad,p.metros,p.unidad,
                    o.descripcion,p.id_seccion as sid,o.id_cliente 
                    FROM presupuestotemporal as p INNER JOIN inventario as i INNER JOIN equivalencias as e 
